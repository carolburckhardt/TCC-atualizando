          ...
          <div class="ui stacked segment">
            <div class="field">
              <div class="ui left input">
                <input type="text" name="nome_r" placeholder="Nome">
              </div>
            </div>
            <div class="field">
              <div class="ui left input">
            ...
            <div class="row">
              <a href="listaRemedios.php?posto=<?=$posto?>"><div class="ui negative basic button">Voltar</div></a>
...
<?php
    ...
    include '../controllers/cadastrarRemedio.php';
?>