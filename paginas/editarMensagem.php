<?php 
  ...
  include '../controllers/editarMensagem.php';
  include '../controllers/coletarMensagemExpecifica.php';    
    ...
    <head>
      ...
      <div class="column six">
        <h1 class="ui image header" id="texto">
          ...
          <div class="content">
          Editar o aviso: <? echo $mensagem['titulo_msg'] ?>
          </div>
        </h1>
        <br>
        <h3></h3>
        <form class="ui large form" id="formulario" method='POST'>
          <div class="ui stacked segment">
            <div class="field">
              ...
              <input type="text" name="titulo" placeholder="Nome" value="<?= $mensagem['titulo_msg'] ?>">
              </div>
            </div>
            <div class="field">
              <div class="ui left input">
              <textarea name="texto" value="<?= $mensagem['texto_msg']?>" id="" cols="30" rows="10"><?= $mensagem['texto_msg']?></textarea>
              </div>
            </div>
