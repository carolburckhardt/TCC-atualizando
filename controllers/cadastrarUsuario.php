...
if(sizeof($_POST)>1){
    ...
    if($_POST['telefone']=="")	{
        ...
        // }	  
            $id = 1;
            $query = "INSERT INTO user (tel, dt_nasc, nome, cpf, email, cep, senha, confir_senha, rua, numero, bairro ,id_tipuser)
                    VALUES ('".$_POST['telefone']."', '".$_POST['dataNascimento']."', '".$_POST['nome']."', ".$_POST['cpf'].", '".$_POST['email']."', '".$_POST['cep']."', '".$_POST['senha']."',  '".$_POST['confirmarSenha']."', '".$_POST['rua']."', '".$_POST['numero']."', '". $_POST['bairro']."','".$id."');";
